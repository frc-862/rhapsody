...
public class Limelights extends SubsystemBase {
    ...
    public Limelights() {
        pressure = new Limelight("limelight-pressure", "10.8.62.11");
        dust = new Limelight("limelight-dust", "10.8.62.12");
        champions = new Limelight("limelight-champions", "10.8.62.13");

        //TODO: make actual pipelines... maybe an enum?
