...
public class LEDs extends SubsystemBase {
    ...
    public void rainbow(int strand) {
        for (int i = 0; i < LEDsConstants.STRAND_LENGTH.get(strand); i++) {
            setStrandSingleHSV(strand, i,
                    (i + (int) (Timer.getFPGATimestamp() * 20)) % LEDsConstants.STRAND_LENGTH.get(strand) * 180
                            / LEDsConstants.STRAND_LENGTH.get(strand),
                    255,
                    255);
        }
    }
    ...
    // setStrandSingleHSV(i, LEDsConstants.RED_HUE, (int) (255 *
    // Math.cos(Math.toRadians(i * 360 / LEDsConstants.STRAND_LENGTH.get(strand)) /
    // 4)),
    // 255);
    // }
    // }
